...
我从事了 10 年的 AI 产品经理职位。在当前 AI 日新月异的今天，作为产品经理（特别是 AI 产品经理），通过开源的技术发展了解和分析技术趋势，已经变成了产品经理的核心能力。

今天，我把我其中一个技术观察的 Skill 开源，它可以帮助你不只看到数据和项目，还能看到开源的趋势与洞察。你可以直接使用你的 OpenClaw、Claude Code 安装并使用这个技能，作为产品经理或 AI Builder 的你会看到意想不到的结果。
